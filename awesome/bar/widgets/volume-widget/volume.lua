...
local utils = require("bar.widgets.volume-widget.utils")
...
local widget_types = {
  icon_and_text = require("bar.widgets.volume-widget.widgets.icon-and-text-widget"),
  icon = require("bar.widgets.volume-widget.widgets.icon-widget"),
  arc = require("bar.widgets.volume-widget.widgets.arc-widget"),
  horizontal_bar = require("bar.widgets.volume-widget.widgets.horizontal-bar-widget"),
  vertical_bar = require("bar.widgets.volume-widget.widgets.vertical-bar-widget"),
}
local volume = {}
